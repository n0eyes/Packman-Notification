...
export const FONT_STYLES = {
  ...
  LANDING2_SEMIBOLD: FONT({ size: 16, weight: "M", type: "subhead1" }),
  LANDING3_SEMIBOLD: FONT({ size: 15, weight: "M", type: "body4" }),
  APPRECIATE_LINE1_BOLD: FONT({ size: 32, weight: "B", type: "display4" }),
  APPRECIATE_LINE2_BOLD: FONT({ size: 24, weight: "B", type: "display4" }),
  APPRECIATE_MEDIUM: FONT({ size: 13, weight: "M", type: "body3" }),
};
